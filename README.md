...
<tr>
  ...
  <td>26/04/2024</td>
  <td>Diego Soriano Medrano</td>
  <td> - Software Object-Oriented Design.<br> -  Class diagram Design. <br> -  Database Design.</td>
</tr>
<tr>
  <td>8.0</td>
  <td>29/04/2024</td>
...
| Story 001| Crear Vacuna| **Como** ganadero, **quiero** agregar una vacuna **para** la lista de vacunas administradas a mi bovinos.| **Scenario 1:** *Agregar vacuna al registro de vacunas* <br> **Given** un ganadero ha iniciado sesión <br> When accede al apartado de vacunas <br> **Then** puede acceder al formulario para una vacuna nueva <br> **And** puede ingresar los datos de la vacuna.<br><br> **Scenario 2:** *Ingresar datos de la vacuna* <br> **Given** un ganadero ha iniciado sesión <br> **When** accede al formulario para agregar vacuna <br> **Then** puede ingresar los datos de la vacuna <br> **And** recibe una confirmación de que la vacuna ha sido agregada.<br><br> **Scenario 3:** *Error al enviar el formulario* <br> **Given** un ganadero ha iniciado sesión <br> **When** ingresa datos incorrectos en el formulario <br> **Then** recibe un mensaje de error <br> **And** se le indica dónde está el error en el formulario. |Epic 1 |
| Story 002     | Búsqueda de Registros   | **Como** ganadero, **quiero** buscar una vacuna **para** no poner las vacunas incorrectas a mi bovino. |**Scenario1:** *Buscar vacuna por fecha de administración* <br>**Given** un ganadero tiene varias vacunas registradas para su bovino <br> **When** busca una vacuna por fecha de administración <br> **Then** ve una lista de vacunas administradas en la fecha especificada.<br><br> **Scenario 2:** *Buscar vacuna por tipo de vacuna* <br> **Given** un ganadero tiene varias vacunas registradas para su bovino <br> **When** busca una vacuna por tipo de vacuna <br>**Then** ve una lista de vacunas del tipo especificado.<br><br> **Scenario 3:** *Búsqueda sin resultados* <br> **Given** un ganadero tiene varias vacunas registradas para su bovino <br> **When** intenta buscar una vacuna que no existe <br> **Then** recibe un mensaje indicando que no se encontraron vacunas con los criterios de búsqueda especificados.| Epic 1 |
| Story 003     | Gestión de Registros    |**Como** ganadero,**quiero** poder eliminar o editar una vacuna **para** asegurarme de que se registren correctamente las vacunas que se le administran a mi bovino.|**Scenario 1:** *Eliminar una vacuna existente* <br> **Given** un ganadero tiene una vacuna registrada para su bovino <br> **When** intenta eliminar la vacuna existente <br> **Then** recibe una confirmación para eliminar la vacuna <br> **And** la vacuna se elimina correctamente.<br><br> **Scenario 2:** *Editar detalles de una vacuna* <br> **Given** un ganadero tiene una vacuna registrada para su bovino <br> **When** intenta editar los detalles de la vacuna <br> **Then** puede actualizar la información de la vacuna correctamente.<br><br> **Scenario 3:** *Error al eliminar una vacuna*<br> **Given** un ganadero tiene una vacuna registrada para su bovino <br> **When** hay un error en el sistema al intentar eliminar la vacuna <br> **Then** no puede eliminar la vacuna <br> **And** recibe un mensaje de error.<br><br> **Scenario 4:** *Error al editar una vacuna* <br> **Given** un ganadero tiene una vacuna registrada para su bovino <br> **When** hay un error en el sistema al intentar editar la vacuna <br> **Then** no puede editar la vacuna <br> **And** recibe un mensaje de error.| Epic 1 |
| Epic 2        |     Registrar Ganado                  |  |**Epic Story**|        |
| Story 004     | Registrar Animal    | **Como** usuario del sistema, **quiero** poder registrar un bovino en un lote específico **para** llevar un control detallado de la crianza y manejo de cada animal. | **Scenario 1:** *Registrar un bovino* <br> **Given** un usuario autenticado en el sistema <br> **When** selecciona la opción para registrar un nuevo bovino <br> **Then** puede ingresar la procedencia, raza, peso inicial, fecha de registro, fotografía del bovino, estado de salud inicial, fecha de nacimiento o edad, y observaciones adicionales <br> **And** el sistema genera un ID único para el bovino <br> **And** asocia el bovino a un lote específico <br> **And** recibe una confirmación de que el registro se realizó con éxito.<br><br> **Scenario 2:** *Intentar registrar un bovino sin autenticarse* <br> **Given** un usuario no autenticado en el sistema <br> **When** intenta acceder al módulo de gestión de lotes <br> **Then** es redirigido a la página de inicio de sesión.<br><br> **Scenario 3:** *Registrar un bovino sin completar todos los campos obligatorios* <br> **Given** un usuario autenticado quiere agregar un bovino en un lote de una campaña <br> **When** intenta registrar el bovino sin completar todos los campos obligatorios <br> **Then** recibe un mensaje de error indicando que todos los campos obligatorios deben completarse.<br><br> **Scenario 4:** *Registrar un bovino con datos no válidos* <br> **Given** un usuario autenticado quiere registrar un bovino <br> **When** intenta registrar datos del bovino que no son válidos <br> **Then** recibe un mensaje de error indicando que los datos ingresados no son válidos y deben cumplir con el formato requerido.| Epic 2 |
| Story 005     | Búsqueda de Animales    |**Como** usuario, **quiero** poder buscar animales **para** encontrar rápidamente la información que necesito.|**Scenario 1:** *Buscar información de animales* <br> **Given** el usuario está autenticado en la plataforma <br> **When** realiza la consulta desde su oficina <br> **And** encuentra la información de sus animales ordenada <br> **Then** debería poder ver los resultados de la búsqueda de manera clara y organizada.| Epic 2 |
| Story 006     | Gestión de Animales     |**Como** usuario, **quiero** poder gestionar la información de los animales registrados **para** mantenerla actualizada y precisa.|**Scenario 1:** *Actualizar información de animales* <br> **Given** el usuario ya se ha autenticado correctamente <br> **When** ingresa al menú de gestión de animales <br> **And** actualiza la información necesaria <br> **Then** se muestra un mensaje de confirmación cuando guarda los cambios.| Epic 2 |
| Epic 3        | Registrar Campaña       |  |**Epic Story**|        |
| Story 007     | Crear Campaña           |**Como** usuario de la plataforma, **quiero** poder crear una campaña **para** engordar el ganado que yo desee asignar.|**Scenario 1:** *Crear campaña como ganadero independiente* <br> **Given** el usuario está autenticado correctamente <br> **When** quiere crear una campaña <br> **And** selecciona la opción para crear campaña <br> **Then** debe seleccionar la duración de la campaña, objetivo, y los animales o establos que participarán.| Epic 3 |
| Story 008    | Asociar Empleados         |**Como** usuario empresario ganadera, **quiero** poder asignar empleados que trabajarán en la empresa **para** organizar mejor a su personal para campañas.   |**Scenario 1:** *Asociar empleados a una campaña* <br> **Given** el usario empresario, loggeado en la aplicación, ha seleccionado la opción de asociar empleados <br> **When** está organizando una campaña <br> **And** selecciona los empleados que darán su apoyo para la misma <br> **Then** los empleados seleccionados deben quedar asociados correctamente a la campaña.| Epic 3 |
| Story 009     | Gestión de Campañas     | **Como** usuario de la plataforma, **quiero** poder manejar la camapaña que organicé con la aplicación. |**Scenario 1:** *Gestionar campaña como usuario ganadero independiente* <br> **Given** el usuario, con la sesión iniciada, ha creado una campaña y desea ver su progreso <br> **And** quiere realizar cambios como añadir o eliminar tiempo, animales o establos, o modificar el objetivo de la campaña <br> **Then** los cambios realizados deben reflejarse instantáneamente en la aplicación.<br><br>**Scenario 2:** *Gestionar campaña como empresa ganadera* <br> **Given** la empresa ha creado una campaña y desea ver su progreso <br> **And** quiere realizar cambios como añadir o eliminar tiempo, animales o establos, personal asignado, o modificar el objetivo de la campaña <br> **Then** los cambios realizados deben reflejarse instantáneamente en la aplicación.| Epic 3 |
...
| Story 010     | Registro de Veterinarios|**Como** usuario **quiero** poder registrarme como veterinario **para** la aplicación web |**Scenario 1:** *Registro de veterinario en la aplicación* <br> **Given** el veterinario se registra correctamente en la aplicación por un usuario administrador <br> **And** se registra exitosamente en el sistema <br> **And** recibe un mensaje de confirmación de registro <br> **Then** el veterinario queda registrado en el sistema y está disponible para ser contactado por los usuarios ganaderos.| Epic 4 |
| Story 011     | Búsqueda de Veterinarios|**Como** usuario de la plataforma **quiero** un menú de búsqueda de veterinarios **para** darle asistencia a mis animales cuando lo necesite. |**Scenario 1:** *Búsqueda de veterinarios en el portal* <br> **Given** el usuario se  ha loggeado e ingresado al portal de búsqueda de veterinarios <br> **And** realiza una búsqueda conforme a sus preferencias <br> **Then** el usuario realiza el pago correspondiente para solicitar la visita del veterinario seleccionado. | Epic 4 |
| Epic 5        | Registrar Personal      |  | **Epic Story** |        |
| Story 012     | Registro de Personal    |**Como** empresario ganadero **quiero** poder registrar a mis empleados **para** organizar mejor mi negocio  |**Scenario 1:** *Registro correcto de personal* <br>**Given** el empresario ganadero autenticado, registra correctamente los datos de cada uno de sus empleados <br>**And** recibe un mensaje de confirmación de registro exitoso.<br><br>**Scenario 2:** *Registro incorrecto de personal* <br> **Given** el empresario ganadero que ya ha iniciado sesión, intenta registrar a su personal pero falta información esencial de uno de los empleados. <br>**Then** se muestra un mensaje de error indicando la falta de datos esenciales durante el intento de registro. | Epic 5 |
| Story 013     | Búsqueda de Personal    |**Como** empresario ganadero **quiero** poder buscar entre mi personal registrado en al applicación **para** poder eliminar a uno |**Scenario 1:** *Búsqueda de empleado para eliminar* <br>**Given** el empresario con la sesión iniciada, busca al empleado en el menú de búsqueda <br>**And** utiliza un filtro de búsqueda para encontrar al empleado específico de manera eficiente <br>**Then** se muestra al empleado encontrado.| Epic 5 |
| Story 014     | Gestión de Personal     | **Como** empresario ganadero **quiero** poder eliminar y agregar empleados **para** poder tener un orden en mi empresa|**Scenario 1:** *Eliminar y agregar empleados* <br>**Given** el empresario que ya inición sesión, ingresa al apartado de gestión de personal <br>**And** realiza cambios en la lista de empleados (eliminar o agregar) <br>**Then** se muestra un mensaje de confirmación de los cambios realizados.| Epic 5 |
...
| Story 015 | Explorar la LandingPage | **Como** visitante **quiero** obtener información de la aplicación **para** determinar si es adecuada para mis necesidades. | **Scenario 1:** *Explorar la sección 'Quiénes Somos'* <br>**Given** el visitante ingresa a la LandingPage <br> **When** navega por la sección de información 'Quiénes Somos' <br> **Then** debe encontrar detalles sobre la misión, visión y valores de la empresa.| Epic 6 |
| Story 016 | Descubrir las secciones informativas | **Como** visitante **quiero** explorar las distintas secciones informativas de la aplicación **para** comprender mejor sus características y funcionalidades | **Scenario 1:** *Explorar secciones informativas* <br> **Given** el visitante ingresa a la LandingPage <br> **When** navega por las secciones 'Quiénes Somos', 'Planes' y 'Funciones' <br> **Then** debe obtener información detallada sobre la empresa, los diferentes planes ofrecidos y las funcionalidades disponibles. | Epic 6 |
...
|---------------|----------|---------|---------------|
|TS001|Crear Formulario| Como desarrollador, quiero que se pueda agregar una vacuna desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Agregar vacuna exitosamente* <br>**Given** que el endpoint "/vacunas" está disponible <br> **When** se envía una solicitud POST con datos válidos para una vacuna<br> **Then** se recibe una respuesta con estado 201 Created <br>**And** la respuesta incluye un recurso de vacuna con un nuevo ID y los datos registrados.<br><br>**Scenario 2:** *Error al agregar vacuna por datos inválidos*<br>**Given** que el endpoint "/vacunas" está disponible <br>**When** se envía una solicitud POST con datos inválidos para una vacuna (por ejemplo, falta el nombre de la vacuna)<br>**Then** se recibe una respuesta con estado 400 Bad Request <br>**And** la respuesta incluye el mensaje de error: "Falta el nombre de la vacuna".<br><br>**Scenario 3:** *Error al agregar vacuna por formato incorrecto de datos* <br> **Given** que el endpoint "/vacunas" está disponible <br> **When** se envía una solicitud POST con datos en un formato incorrecto para una vacuna (por ejemplo, fecha de vacunación no válida) <br> **Then** se recibe una respuesta con estado 400 Bad Request <br> **And** la respuesta incluye el mensaje de error: "Formato de fecha de vacunación no válido".<br><br>**Scenario 4:** Error al agregar vacuna duplicada <br> **Given** que el endpoint "/vacunas" está disponible <br>**And** ya existe una vacuna con el mismo nombre registrada <br>**When** se envía una solicitud POST con datos para una vacuna que ya existe <br> **Then** se recibe una respuesta con estado 409 Conflict <br> **And** la respuesta incluye el mensaje de error: "Ya existe una vacuna con el mismo nombre".|
|TS002|Búsqueda de registros| Como desarrollador, quiero crear una forma de buscar las vacunas desde un API para que pueda estar disponible entre los features de la aplicación |**Scenario 1:** Búsqueda de animales exitosa<br>**Given** que el endpoint "/vacunas" está disponible <br> **And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de vacunas <br> **When** se hace una solicitud GET a /vacunas con parámetros de búsqueda válidos<br> **Then** se recibe una respuesta con estado 200 OK <br> **And** la respuesta contiene una lista de vacunas que coinciden con los criterios de búsqueda.<br><br>**Scenario 2:** Búsqueda de vacunas sin resultados<br> **Given** que el endpoint "/vacunas" está disponible<br> **And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de vacunas <br> **When** se hace una solicitud GET a /vacunas con parámetros de búsqueda válidos que no arrojan resultados<br> **Then** se recibe una respuesta con estado 200 OK <br> **And** la respuesta contiene un mensaje indicando que no se encontraron vacunas que coincidan con los criterios de búsqueda.|
|TS003|Gestion de registros | Como desarrollador, Quiero crear una opción de eliminar o editar una vacuna desde un API para que pueda estar disponible este feature en la aplicación |**Scenario 1:** *Editar vacuna exitosamente*<br>**Given** el desarrollador selecciona un vacuna existente y modifica la información con datos válidos<br>**When** hace una solicitud PUT a /vacunas/{id} con la información actualizada<br>**Then** la respuesta es 200 OK y contiene la vacuna actualizada<br><br>**Scenario 2:** *Error al editar vacuna* <br>**Given** el desarrollador selecciona un vacuna existente y modifica la información con datos inválidos<br>**When** hace una solicitud PUT a /vacunas/{id} con información inválida<br>**Then** la respuesta es 400 Bad Request y contiene un mensaje de error.<br><br>**Scenario 3:** *Eliminar vacuna exitosamente*<br>**Given** el desarrollador selecciona un animal existente para eliminar<br>**When** hace una solicitud DELETE a /vacunas/{id}<br>**Then**la respuesta es 200 OK y contiene un mensaje de éxito.|
|TS004|Registrar Animal | Como desarrollador, quiero crear un registro de un bovinos en un lote específico desde un API para que pueda estar disponible los features de la aplicación.| **Scenario 1:** *Registrar animal exitosamente*<br>**Given** que el endpoint "/animales" está disponible<br> **And** el desarrollador completa el formulario de registro de animales con información válida<br> **When** se hace una solicitud POST a /animales<br> **Then** se recibe una respuesta con estado 201 Created <br>**And** la respuesta contiene el animal agregado.<br><br>**Scenario 2:** *Error al registrar animal*<br> **Given** que el endpoint "/animales" está disponible<br> **And** el desarrollador completa el formulario de registro de animales con información inválida<br> **When** se hace una solicitud POST a /animales<br> **Then** se recibe una respuesta con estado 400 Bad Request<br> **And** la respuesta contiene un mensaje de error.|
|TS005|Búsqueda de Animales| Como desarrollador, quiero crear una herramienta de buscar animales desde un API para que pueda estar disponible entre los features de la aplicación |**Scenario 1:** *Búsqueda de animales exitosa*<br> **Given** que el endpoint "/animales" está disponible<br>**And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de animales<br> **When** se hace una solicitud GET a /animales con parámetros de búsqueda válidos<br>**Then** se recibe una respuesta con estado 200 OK<br> **And** la respuesta contiene una lista de animales que coinciden con los criterios de búsqueda.|
|TS006|Gestión de animales| Como desarrollador, quiero crear una herramienta de gestionar animales desde un API para que pueda estar disponible en la aplicación web|**Scenario 1:** *Editar animal exitosamente*<br>**Given** que el endpoint "/animales/{id}" está disponible<br> **And** el desarrollador selecciona un animal existente y modifica la información con datos válidos<br> **When** se hace una solicitud PUT a /animales/{id} con la información actualizada<br> **Then** se recibe una respuesta con estado 200 OK<br> **And** la respuesta contiene el animal actualizado.<br><br> **Scenario 2:** *Eliminar animal exitosamente*<br> **Given** que el endpoint "/animales/{id}" está disponible<br> **And** el desarrollador selecciona un animal existente para eliminar<br> **When** se hace una solicitud DELETE a /animales/{id}<br> **Then** se recibe una respuesta con estado 200 OK<br> **And** la respuesta contiene un mensaje de éxito.|
|TS007|Crear Campaña|Como usuario de la plataforma, quiero poder crear una campaña desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Crear campaña exitosamente* <br> **Given** que el endpoint "/campanas" está disponible <br> **And** el usuario completa el formulario de creación de campaña con información válida<br> **When** se hace una solicitud POST a /campanas<br>**Then** se recibe una respuesta con estado 201 Created<br> **And** la respuesta contiene la campaña agregada.<br><br>**Scenario 2:** *Error al crear campaña*<br>**Given** que el endpoint "/campanas" está disponible<br> **And** el usuario completa el formulario de creación de campaña con información inválida<br> **When** se hace una solicitud POST a /campanas<br> **Then** se recibe una respuesta con estado 400 Bad Request<br>**And** la respuesta contiene un mensaje de error.|
|TS008|Asociar Empleados |Como usuario de la plataforma, quiero poder asociar empleados a campañas desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Asociar empleado a campaña exitosamente*<br> **Given** que el endpoint "/campanas/{id}/empleados" está disponible<br> **And** el usuario selecciona una campaña existente y un empleado válido<br> **When** se hace una solicitud POST a /campanas/{id}/empleados<br>**Then** se recibe una respuesta con estado 201 Created<br> **And** la respuesta contiene la asociación exitosa.<br><br>**Scenario 2:** *Error al asociar empleado*<br>**Given** que el endpoint "/campanas/{id}/empleados" está disponible<br>**And** el usuario selecciona una campaña existente y un empleado inválido<br>**When** se hace una solicitud POST a /campanas/{id}/empleados<br>**Then** se recibe una respuesta con estado 400 Bad Request<br> **And** la respuesta contiene un mensaje de error.|
|TS009| Gestión de Campañas|Como desarrollador de la plataforma, quiero desarrollar una herramienta para manejar la campañas desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Editar campaña exitosamente*<br> **Given** que el endpoint "/campanas/{id}" está disponible<br>**And** el desarrollador selecciona una campaña existente y modifica la información con datos válidos<br>**When** se hace una solicitud PUT a /campanas/{id} con la información actualizada<br>**Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene la campaña actualizada.<br><br>**Scenario 2:** *Error al editar campaña*<br>**Given** que el endpoint "/campanas/{id}" está disponible<br>**And** el desarrollador selecciona una campaña existente y modifica la información con datos inválidos<br>**When** se hace una solicitud PUT a /campanas/{id} con información inválida<br>**Then** se recibe una respuesta con estado 400 Bad Request<br>**And** la respuesta contiene un mensaje de error.<br><br>**Scenario 3:** *Eliminar campaña exitosamente*<br>**Given** que el endpoint "/campanas/{id}" está disponible<br> **And** el desarrollador selecciona una campaña existente para eliminar<br>**When** se hace una solicitud DELETE a /campanas/{id}<br>**Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene un mensaje de éxito.|
|TS010 | Registro de Veterinarios | Como desarrollador quiero crear una función de registro para veterinarios  desde un API para que pueda estar en la aplicación|**Scenario 1:** *Registrar veterinario exitosamente* <br>**Given** que el endpoint "/veterinarios" está disponible<br>**And** el desarrollador completa el formulario de registro de veterinarios con información válida<br>**When** se hace una solicitud POST a /veterinarios<br>**Then** se recibe una respuesta con estado 201 Created<br>**And** la respuesta contiene el veterinario agregado.<br><br>**Scenario 2:** *Error al registrar veterinario*<br>**Given** que el endpoint "/veterinarios" está disponible<br>**And** el desarrollador completa el formulario de registro de veterinarios con información inválida<br>**When** se hace una solicitud POST a /veterinarios<br>**Then** se recibe una respuesta con estado 400 Bad Request<br>**And** la respuesta contiene un mensaje de error.|
|TS011 | Búsqueda de Veterinarios | Como desarrollador de la plataforma quiero un menú de búsqueda de veterinarios desde un API para que pueda estar disponible los features de la aplicación |**Scenario 1:**  *Búsqueda de veterinarios exitosa*<br>**Given** que el endpoint "/veterinarios" está disponible<br>**And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de veterinarios<br> **When** se hace una solicitud GET a /veterinarios con parámetros de búsqueda válidos<br>**Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene una lista de veterinarios que coinciden con los criterios de búsqueda.<br><br>**Scenario 2:** *Búsqueda de veterinarios sin resultados*<br>**Given** que el endpoint "/veterinarios" está disponible<br> **And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de veterinarios<br>**When** se hace una solicitud GET a /veterinarios con parámetros de búsqueda válidos<br>**Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene un mensaje indicando que no se encontraron veterinarios.|
|TS012 | Registro de Personal | Como desarrollador quiero crear las funciones para poder registrar empleados  desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Registrar empleado exitosamente*<br>**Given** que el endpoint "/empleados" está disponible<br>**And** el desarrollador completa el formulario de registro de empleados con información válida<br> **When** se hace una solicitud POST a /empleados<br>**Then** se recibe una respuesta con estado 201 Created<br>**And** la respuesta contiene el empleado agregado.<br><br>**Scenario 2:** *Error al registrar empleado* <br>**Given** que el endpoint "/empleados" está disponible<br>**And** el desarrollador completa el formulario de registro de empleados con información inválida<br> **When** se hace una solicitud POST a /empleados<br>**Then** se recibe una respuesta con estado 400 Bad Request<br> **And** la respuesta contiene un mensaje de error.|
|TS013 | Búsqueda de Personal | Como desarrollador quiero poder crear un sistema para que el personal de los usuarios empresarios quede registrado desde un API para la aplicación |**Scenario 1:** *Búsqueda de empleados exitosa* <br> **Given** que el endpoint "/empleados" está disponible<br> **And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de empleados<br>**When** se hace una solicitud GET a /empleados con parámetros de búsqueda válidos<br> **Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene una lista de empleados que coinciden con los criterios de búsqueda.<br><br> **Scenario 2:** *Búsqueda de empleados sin resultados*<br> **Given** que el endpoint "/empleados" está disponible<br> **And** el desarrollador ingresa criterios de búsqueda válidos en el formulario de búsqueda de empleados<br>**When** se hace una solicitud GET a /empleados con parámetros de búsqueda válidos<br> **Then** se recibe una respuesta con estado 200 OK<br>**And** la respuesta contiene un mensaje indicando que no se encontraron empleados.|
|TS014 | Gestión de Personal | Como desarrollador quiero crear la funciones para eliminar y agregar empleados y que sea posible gestionar el personal de la empresa  desde un API para que pueda estar disponible los features de la aplicación|**Scenario 1:** *Editar empleado exitosamente* <br> **Given** que el endpoint "/empleados/{id}" está disponible<br> **And** el desarrollador selecciona un empleado existente y modifica la información con datos válidos<br> **When** se hace una solicitud PUT a /empleados/{id} con la información actualizada<br>  **Then** se recibe una respuesta con estado 200 OK<br> **And** la respuesta contiene el empleado actualizado.<br> <br> **Scenario 2:** *Error al editar empleado*<br> **Given** que el endpoint "/empleados/{id}" está disponible<br> **And** el desarrollador selecciona un empleado existente y modifica la información con datos inválidos<br> **When** se hace una solicitud PUT a /empleados/{id} con información inválida<br>  **Then** se recibe una respuesta con estado 400 Bad Request<br>  **And** la respuesta contiene un mensaje de error.<br> <br> **Scenario 3:** *Eliminar empleado exitosamente* <br> **Given** que el endpoint "/empleados/{id}" está disponible<br>  **And** el desarrollador selecciona un empleado existente para eliminar<br> **When** se hace una solicitud DELETE a /empleados/{id}<br> **Then** se recibe una respuesta con estado 200 OK<br> **And** la respuesta contiene un mensaje de éxito.|
...
|-------|----------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| 1     | Story 001            | Crear Vacuna                          | Como ganadero, quiero agregar una vacuna a la lista de vacunas administradas a mis bovinos.                                                                                              | 2                         |
| 2     | Story 002            | Búsqueda de vacunas               | Como ganadero, quiero buscar una vacuna para evitar administrar vacunas incorrectas a mis bovinos.                                                                                        | 2                         |
| 3     | Story 003            | Gestión de Registros                 | Como ganadero, quiero poder eliminar o editar una vacuna para asegurarme de que se registren correctamente las vacunas administradas a mis bovinos.                                        | 3                         |
| 4     | Story 004            | Registrar Animal                     | Como usuario del sistema, quiero registrar un bovino en un lote específico para llevar un control detallado de la crianza y manejo de cada animal.                                          | 2                         |
...
| 6     | Story 006            | Gestión de Animales                  | Como usuario, quiero gestionar la información de los animales registrados para mantenerla actualizada y precisa.                                                                        | 3                         |
| 7     | Story 007            | Crear Campaña                        | Como usuario de la plataforma, quiero crear una campaña para engordar el ganado que deseo asignar.                                                                                      | 2                         |
| 8     | Story 008            | Asociar Empleados                    | Como usuario empresa ganadera, quiero asignar empleados que trabajarán en la empresa para organizar mejor a mi personal para campañas.                                                  | 2                         |
| 9     | Story 009            | Gestión de Campañas                  | Como usuario de la plataforma, quiero manejar la campaña que organicé con la aplicación.                                                                                                | 3                         |
| 10    | Story 010            | Registro de Veterinarios             | Como usuario, quiero registrarme como veterinario en la aplicación web.                                                                                                                  | 2                         |
| 11    | Story 011            | Búsqueda de Veterinarios             | Como usuario de la plataforma, quiero buscar veterinarios para darle asistencia a mis animales cuando lo necesite.                                                                      | 2                         |
| 12    | Story 012            | Registro de Personal                 | Como empresario ganadero, quiero registrar a mis empleados para organizar mejor mi negocio.                                                                                              | 2                         |
| 13    | Story 013            | Búsqueda de Personal                 | Como empresario ganadero, quiero buscar entre mi personal registrado en la aplicación para poder eliminar a uno.                                                                        | 2                         |
| 14    | Story 014            | Gestión de Personal                  | Como empresario ganadero, quiero eliminar y agregar empleados para tener un orden en mi empresa.                                                                                         | 3                         |
| 15    | Story 015            | Explorar la LandingPage              | Como visitante, quiero obtener información de la aplicación para evaluar si es adecuada para mis necesidades.                                                                             | 1                         |
| 16    | Story 016            | Descubrir las secciones informativas | Como visitante, quiero explorar las secciones informativas de la aplicación para comprender mejor sus características y funcionalidades.                                                  | 2                         |

| Orden | Technical Story | Título                    | Descripción                                                                                                                                                                             | Story Points (1 / 2 / 3) |
|-------|-----------------|---------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| 1 |TS001    | Crear Vacuna              | Como desarrollador, quiero que se pueda agregar una vacuna desde un API para que esté disponible en los features de la aplicación.                                                     | 3                       |
| 2 | TS002 | Búsqueda de Vacuna        | Como desarrollador, quiero crear una forma de buscar las vacunas desde un API para que esté disponible entre los features de la aplicación.                                            | 2                       |
| 3 | TS003 | Gestión de Vacuna         | Como desarrollador, quiero crear una opción de eliminar o editar una vacuna desde un API para que esté disponible este feature en la aplicación.                                     | 3                       |
| 4 | TS004 | Registrar Animal          | Como desarrollador, quiero crear un registro de bovinos en un lote específico desde un API para que esté disponible en los features de la aplicación.                                 | 3                       |
| 5 | TS005 | Búsqueda de Animales      | Como desarrollador, quiero crear una herramienta de búsqueda de animales desde un API para que esté disponible entre los features de la aplicación.                                    | 2                       |
| 6 |TS006 | Gestión de animales       | Como desarrollador, quiero crear una herramienta de gestión de animales desde un API para que esté disponible en la aplicación web.                                                     | 3                       |
|7 |  TS007   | Crear Campaña             | Como usuario de la plataforma, quiero poder crear una campaña desde un API para que esté disponible en los features de la aplicación.                                                  | 3                       |
|8 |  TS008 | Asociar Empleados         | Como usuario de la plataforma, quiero poder asociar empleados a campañas desde un API para que esté disponible en los features de la aplicación.                                     | 2                       |
| 9 |  TS009 | Gestión de Campañas       | Como desarrollador de la plataforma, quiero desarrollar una herramienta para manejar las campañas desde un API para que esté disponible en los features de la aplicación.              | 3                       |
| 10 | TS010 | Registro de Veterinarios  | Como desarrollador, quiero crear una función de registro para veterinarios desde un API para que esté disponible en la aplicación.                                                     | 2                       |
| 11 | TS011 | Búsqueda de Veterinarios  | Como desarrollador de la plataforma, quiero un menú de búsqueda de veterinarios desde un API para que esté disponible en los features de la aplicación.                                 | 2                       |
| 12 | TS012 | Registro de Personal      | Como desarrollador, quiero crear funciones para poder registrar empleados desde un API para que esté disponible en los features de la aplicación.                                        | 2                       |
| 13 | TS013 | Búsqueda de Personal      | Como desarrollador, quiero crear un sistema para que el personal de los usuarios empresarios quede registrado desde un API para la aplicación.                                          | 1                       |
| 14 | TS014 | Gestión de Personal       | Como desarrollador, quiero crear funciones para eliminar y agregar empleados y que sea posible gestionar el personal de la empresa desde un API para que esté disponible en los features de la aplicación. | 2                       |
...
![principal web esp ](./assets/DBAM_1.PNG)
<BR>

**User Home y vistas previas para el usuario en Organizaciones y Gestión del Ganado:**
<BR>

![principal web esp ](./assets/DBAM_2.PNG)
<BR>

**Menú de opciones y vista previa a los menus de registro y registro de Campaña:**
<BR>

![principal web esp ](./assets/DBAM_3.PNG)
<BR>
...
![Database Diagram](./assets/bd_Aplicaciones_Web.png "Database Diagram")
...
|--------------|-------|---------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1            | 15    | Explorar la LandingPage  | - Diseñar una página de inicio atractiva y fácil de usar.<br>- Escribir contenido relevante y persuasivo para la página de inicio.<br>- Integrar enlaces y recursos útiles para los visitantes interesados.<br>- Realizar pruebas exhaustivas para asegurar la funcionalidad y la usabilidad de la página de inicio.                      |
|1 | 16 | Descubrir las secciones informativas | - Diseñar apartado de QUIÉNES SOMOS, PLANES  y FUNCIONES.<br> -Botón de registro.|
...
| Story Points | Orden | User Story                | Tareas                                                                                                                                                                                                                                                                                                                                                                                                                   |
|--------------|-------|---------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3            | 1     | Registrar Vacuna          | - Implementar formulario de registro de vacunas.<br>- Crear backend para almacenar datos de vacunación.<br>- Conectar frontend y backend para el registro de vacunas.<br>- Realizar pruebas de integración.                                                                                                                                                                                                            |
| 3            | 2     | Registrar Animal          | - Diseñar interfaz de registro de bovinos.<br>- Desarrollar funcionalidad para añadir bovinos a lotes específicos.<br>- Integrar registro de animales con sistema de control de crianza.<br>- Verificar la funcionalidad a través de pruebas unitarias.                                                                                                                                                              |
| 3            | 3     | Crear Campaña             | - Diseñar interfaz de creación de campañas.<br>- Implementar lógica para asignar animales a campañas de engorde.<br>- Realizar pruebas de aceptación para garantizar la creación correcta de campañas.                                                                                                                                                                                                               |
| 3            | 4     | Gestión de Animales       | - Diseñar interfaz de gestión de animales.<br>- Desarrollar funcionalidad para visualizar, editar y eliminar información de animales.<br>- Integrar gestión de animales con otras partes del sistema.<br>- Realizar pruebas exhaustivas para asegurar la integridad de los datos y la funcionalidad.                                                                                                                 |
| 2            | 5     | Asociar Empleados         | - Implementar funcionalidad para asignar empleados a tareas específicas.<br>- Diseñar interfaz para la asignación y gestión de empleados.<br>- Integrar gestión de empleados con el sistema general de la aplicación.<br>- Verificar la funcionalidad y usabilidad a través de pruebas de usuario.                                                                                                                     |
| 2            | 6     | Búsqueda de Registros     | - Desarrollar función de búsqueda para registros de vacunas.<br>- Implementar algoritmo de búsqueda eficiente para encontrar vacunas por criterios específicos.<br>- Integrar función de búsqueda en la interfaz de usuario.<br>- Realizar pruebas exhaustivas para garantizar la precisión y la velocidad de la búsqueda.                                                                                         |
| 2            | 7     | Informarse sobre el producto | - Crear una página de inicio informativa que describa las características y funcionalidades de la aplicación.<br>- Diseñar una interfaz de usuario atractiva y fácil de entender.<br>- Escribir contenido claro y conciso para la página de inicio.<br>- Integrar enlaces y recursos útiles para los visitantes interesados.                                                                                                    |
| 2            | 8     | Gestión de Registros      | - Implementar funcionalidad para editar y eliminar registros de vacunas.<br>- Diseñar una interfaz de usuario intuitiva para la gestión de registros.<br>- Integrar la gestión de registros con el sistema principal de la aplicación.<br>- Realizar pruebas exhaustivas para asegurar la integridad de los datos y la funcionalidad.                                                                                     |
| 2            | 9     | Búsqueda de Animales      | - Desarrollar función de búsqueda para encontrar animales por distintos criterios (identificación, raza, etc.).<br>- Integrar función de búsqueda en la interfaz de usuario.<br>- Realizar pruebas para asegurar la precisión y la velocidad de la búsqueda.                                                                                                                                                      |
| 1            | 10    | Registro de Veterinarios  | - Implementar formulario de registro para veterinarios.<br>- Crear backend para almacenar datos de veterinarios.<br>- Conectar frontend y backend para el registro de veterinarios.<br>- Realizar pruebas de integración.                                                                                                                                                                                           |
| 1            | 11    | Búsqueda de Veterinarios  | - Desarrollar función de búsqueda para encontrar veterinarios por especialidad o ubicación.<br>- Integrar función de búsqueda en la interfaz de usuario.<br>- Realizar pruebas para asegurar la precisión y la velocidad de la búsqueda.                                                                                                                                                                      |
| 1            | 12    | Gestión de Personal       | - Implementar funcionalidad para agregar y eliminar empleados.<br>- Diseñar una interfaz de usuario clara y fácil de usar para la gestión de personal.<br>- Integrar la gestión de personal con el sistema principal de la aplicación.<br>- Realizar pruebas exhaustivas para asegurar la integridad de los datos y la funcionalidad.                                                                                 |
| 1            | 13    | Registrar Personal        | - Implementar formulario de registro para nuevos empleados.<br>- Crear backend para almacenar datos de empleados.<br>- Conectar frontend y backend para el registro de empleados.<br>- Realizar pruebas de integración.                                                                                                                                                                                           |
| 1            | 14    | Contacto de Veterinario   | - Desarrollar funcionalidad para que los usuarios puedan contactar a veterinarios a través de la aplicación.<br>- Diseñar una interfaz de usuario que facilite el contacto con veterinarios.<br>- Integrar el sistema de contacto con los perfiles de los veterinarios.<br>- Realizar pruebas para garantizar la fiabilidad y la seguridad del sistema de contacto.                                                   |
